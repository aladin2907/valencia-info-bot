...
Обсуждения идут от свежих к старым, а НЕ по важности: нужное может стоять последним.
Просмотри все до одного, прежде чем сказать, что информации нет.
Если сведения расходятся — верь более свежему обсуждению.
